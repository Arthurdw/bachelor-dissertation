...
\itodo{angular: relative performance}
\itodo{angular: calculate added size}
...
\begin{table}[H]
    ...
    \resizebox{\columnwidth}{!}{
        \begin{tabular}{|l|l|}
            ...
            Ecosystem                                & 0.81 \textit{(quality: 0.82, size: 0.8; \autoref{tab:metrics:angular:ratings} \autoref{tab:metrics:size})} \\ \hline
    ...
    \caption{Angular general scores}
    \label{tab:angular:scores}
\end{table}