...
\textit{Note: While LLMs are excellent, they are not flawless, so the prompts have been used as a guide rather than a definitive result. There has been no copy-pasting, but rather a rewriting process to match the AI's output.}
